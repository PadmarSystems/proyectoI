...
class usuario extends SafeMySQL {
    ...
    function loginusuario($usuario, $password) {
        ...
        $sql = "SELECT usuario.idUsuario,usuario.nombreUsuario,usuario.email,empresa.idEmpresa,empresa.aliasEmpresa FROM usuarios,empresas WHERE usuario.idEmpresa=empresa.idEmpresa AND email LIKE '$usuario' AND contrasena LIKE '$password' LIMIT 1";
