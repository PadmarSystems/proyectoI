...
<div class="row">
	...
	<form action="empleados/controlador.php" enctype="multipart/form-data" method="post" class="col-md-8 group" onsubmit="return validEmp()">
		...
		<div class="row">
			...
			<div class="col-md-8"><input type="text" required name="nombreAa" <?php echo $readonly; ?> id="nombreAa" value="<?php echo $form['nombreAa']; ?>"/></div>
		</div>
		<div class="row">
			<label class="col-md-4"><b>* </b>Teléfono de contacto: </label>
			<div class="col-md-8"><input type="text" required name="telefonoAa" <?php echo $readonly; ?> id="telefonoAa" pattern="\d{10}" value="<?php echo $form['telAa']; ?>"/></div>
		</div>
		<div class="row">
			<input type="hidden" id="idEmpresaEmp" name="idEmpresaEmp" value="<?php echo $form['idEmpresa']; ?>"/>
			<?php if($_GET['ac']=="editar"){ ?>
			<input type="hidden" id="idEmpleado" name="idEmpleado" value="<?php echo $form['idEmpleado']; ?>"/>
			<?php } ?>
